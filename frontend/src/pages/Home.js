    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            try {
                ...
                console.log('Sending request to:', `http://localhost:5000/api/animes?${queryParams}`);
    ...
    return (<div className="home-page">
        ...
        <section className="results-section">
            ...
            <div className="anime-grid">
                {animeList.map(anime => <Link to={`/anime/${anime.id}`} key={anime.id} className="anime-card-link">
